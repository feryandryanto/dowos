				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="halUser.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="paket.php"> Paket Wisata</a></p>
						</div>	
					</div>
				</div>
			</section>
		            ...
		            <div class="row d-flex justify-content-center">
		                <div class="menu-content pb-70 col-lg-8">
		                    <div class="title text-center">
		                        <h1 class="mb-10">Pilih Paket Wisata</h1>
		                    </div>
		                </div>
		            </div>						
					<div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket1d.php" class="price-btn">IDR 100.000/pax</a>			
									<h4>Paket Wisata OneDay</h4>
									<p>Kecamatan Kejajar</p>		
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket1da.php" class="price-btn">IDR 200.000/pax</a>			
									<h4>Paket Wisata OneDay</h4>
									<p>Kecamatan Garung dan Wonosobo</p>		
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket1day.php" class="price-btn">IDR 300.000/pax</a>			
									<h4>Paket Wisata OneDay</h4>
									<p>Kecamatan Watumalang, Kaliwiro, dan Wadaslintang</p>		
								</div>
							</div>
						</div>
						<div class="col-lg-4" style="padding-top: 30px;">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket2.php" class="price-btn">IDR 400.000/pax</a>			
									<h4>Paket Wisata 2D1N</h4>
									<p>Kecamatan Kejajaran dan Garung</p>		
								</div>
							</div>
						</div>
						<div class="col-lg-4" style="padding-top: 30px;">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket2n.php" class="price-btn">IDR 500.000/pax</a>			
									<h4>Paket Wisata OneDay</h4>
									<p>Kecamatan Wonosobo, Watumalang, dan Wadaslintang</p>		
								</div>
							</div>
						</div>
						<div class="col-lg-4" style="padding-top: 30px;">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket3.php" class="price-btn">IDR 100.000/pax</a>			
									<h4>Paket Wisata 3D2N</h4>
									<p>Keliling Seluruh Objek Wisata</p>		
								</div>
							</div>
						</div>												
					</div>
