				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="halUser.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="paket.php"> Paket Wisata</a> <span class="lnr lnr-arrow-right"></span> <a href="paket1d.php"> Paket Wisata 2N1D</a></p>
						</div>	
					</div>
				</div>
			</section>
...
<!-- isi -->
					<br>
					<h2 style="padding-left: 100px;">Paket 2 Night 1 Day</h2>
					<p style="padding-left: 100px;">IDR 400.000/pax
						<br>Kecamatan Kejajar dan Garung</p>
					<div class="row">
						<div class="col-lg-4">
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="img/paket/k1.jpg" alt="">
								</div>
								<div class="desc">			
									<p>Bukit Sambrani</p>		
								</div>
					...
					<div class="col-lg-4 col-md-6 banner-right">
							...
							<div class="tab-content" id="myTabContent">
							  ...
							  <ul>
							  	<h3>Keterangan</h3>
							  	<li>- Paket 2N1D dapat diikuti minimal 2 peserta</li>
