				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="halUser.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="paket.php"> Paket Wisata</a> <span class="lnr lnr-arrow-right"></span> <a href="paket1d.php"> Paket Wisata OneDay</a></p>
						</div>	
					</div>
				</div>
			</section>
...
<!-- isi -->
					<br>
					<h2 style="padding-left: 100px;">Paket OneDay</h2>
					<p style="padding-left: 100px;">IDR 200.000/pax
						<br>Kecamatan Garung dan Wonosobo</p>	
					</br>
							            <div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="img/paket/a1.jpg" alt="">
								</div>
								<div class="desc">			
									<p>Wisata Alam Seroja</p>		
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="img/paket/a2.jpg" alt="">
								</div>
								<div class="desc">			
									<p>Telaga Menjer</p>		
								</div>
							...
							<div class="tab-content" id="myTabContent">
							  <div class="tab-pane fade show active" style="padding-left: 100px;" id="flight" role="tabpanel" aria-labelledby="flight-tab">
							  	...
							  	<h3>Destinasi Wisata</h3>
							  		<li>- Telaga Menjer</li>
							  		<li>- TWisata Alam Seroja</li>
							  		<li>- Bukit Cinta Seroja</li>
							  		<li>- Desa Budaya</li>
							  		<li>- Wonoland</li>
							  		<li>- Taman Kali Anget</li>
							  	</ul>
							  	<br>
							  	<ul>
							  ...
							  <ul>
							  	<h3>Keterangan</h3>
							  	<li>- Paket OneDay dapat diikuti minimal 2 peserta</li>
...
?>
							...
							<div class="tab-pane fade" id="hotel" role="tabpanel" aria-labelledby="hotel-tab" style="padding-left: 100px;"><br>
			...
			<!-- start footer Area -->		
			<footer class="footer-area section-gap" style="margin-right: -100px;">
				<div class="container">
