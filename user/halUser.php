		            ...
		            <div class="row d-flex justify-content-center">
		                <div class="menu-content pb-70 col-lg-8">
		                    <div class="title text-center">
		                        <h1 class="mb-10">Tujuan Teratas</h1>
		                    </div>
		                </div>
		            </div>						
					<div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket1da.php" class="price-btn">IDR 200.000</a>			
									<h4>Paket Wisata OneDay</h4>
									<p>Kabupaten Garung dan Wonosobo</p>			
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket1d.php" class="price-btn">IDR 100.000</a>			
									<h4>Paket Wisata OneDay</h4>
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								...
								<div class="desc">	
									<a href="paket2.php" class="price-btn">IDR 400.000</a>			
									<h4>Paket Wisata 2D1N</h4>
									<p>Kecamatan Kejajar dan Garung</p>			
								</div>
							</div>
						</div>												
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								...
								<a href="blog-sejarah.php">
									<h4>Sejarah Tempat Wisata</h4>
								</a>
								<p>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								...
								<a href="blog-kuliner.php">
									<h4>Makanan dan Buah Tangan</h4>
								</a>
								<p>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								...
								<a href="blog-tips.php">
									<h4>Tips-Tips</h4>
								</a>
								<p>
									Persiapan apa saja yang kamu bawa saat hendak berlibur ke Wonosobo? Jangan lupa simak tips dari kita.
								</p>
							</div>
						</div>																		
					</div>
