				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="halUser.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="blog.php">Blog</a> <span class="lnr lnr-arrow-right"></span>  <a href="blog-kuliner.php">Kuliner Khas Wonosobo</a></p>
						</div>	
					</div>
				</div>
			</section>
							...
							<div class="single-post row" style="width: 1140px;">
								<div class="col-lg-12">
									<div class="feature-img">
										<img class="img-fluid" src="img/blog/kuliner.jpg" alt="">
									</div>									
								</div>

								<div class="col-lg-9 col-md-9">
									<h3 class="mt-20 mb-20">Kuliner Khas Wonosobo</h3>
									<p class="excert">
