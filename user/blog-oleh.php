				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								Buah Tangan Wonosobo				
							</h1>	
							<p class="text-white link-nav"><a href="halUser.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="blog.php">Blog</a> <span class="lnr lnr-arrow-right"></span>  <a href="blog-oleh.php">Buah Tangan Wonosobo</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="col-lg-8 posts-list">
							<div class="single-post row" style="width: 1140px;">
								...
								<div class="col-lg-9 col-md-9">
									<h3 class="mt-20 mb-20">Buah Tangan Wonosobo</h3>
									<p class="excert">
