			...
			<header id="header">
				<div class="container main-menu"><button type="button" id="mobile-nav-toggle"></button>
					<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="halUser.html"><img src="img/logo2.png" alt="" title="" style="margin-right: 10px;">Dolan Wonosobo</a>
				      </div>
...
?>
							...
							<form method="post" action="transaksi.php">
								...
								<div>
									...
									<input type="text" name="dewasa" readonly value="<?php echo $tampil['dewasa']-$tampil['anak'];?>" style="width: 34px;" >
								</div>
								<div>
