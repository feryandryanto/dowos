							...
							<div class="single-post row">
								...
								<div class="col-lg-9 col-md-9 ">
									<div class="feature-img">
										<img class="img-fluid" src="img/blog/kuliner.jpg" alt style="padding-top: 25px">
									</div>
									<a class="posts-title" href="blog-kuliner.php"><h3>Kuliner Wonosobo</h3></a>
									<p class="excert">
										Setelah menikmati objek wisata, jagan lupa cicipi makanan yang akan memanjakan lidahmu. ets, jangan lupa bawa buah tangan.
									</p>
									<a href="blog-kuliner.php" class="primary-btn">View More</a>
								</div>
							</div>
							<div class="single-post row">
								<div class="col-lg-3  col-md-3 meta-details">
								...
								<div class="col-lg-9 col-md-9 ">
									<div class="feature-img">
										<img class="img-fluid" src="img/blog/oleh.jpg" alt="">
									</div>
									<a class="posts-title" href="blog-oleh.php"><h3>Buah Tangan Wonosobo</h3></a>
									<p class="excert">
										Setelah menikmati objek wisata, jagan lupa cicipi makanan yang akan memanjakan lidahmu. ets, jangan lupa bawa buah tangan.
									</p>
									<a href="blog-oleh.php" class="primary-btn">View More</a>
								</div>
							</div>
							<div class="single-post row">
								<div class="col-lg-3 col-md-3 meta-details">
								...
								<div class="col-lg-9 col-md-9">
									<div class="feature-img">
										<img class="img-fluid" src="img/blog/event.png" alt="">
									</div>
									<a class="posts-title" href="blog-event.php"><h3>Event Wonosobo</h3></a>
									<p class="excert">
										Kamu harus tahu bebagai event meriah yang wajib kamu tonton atau kunjungi.
									</p>
									<a href="blog-event.php" class="primary-btn">View More</a>
								</div>
							</div>														
