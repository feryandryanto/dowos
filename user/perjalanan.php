...
<html lang="zxx" class="no-js" style="display: block;"><head>
		...
		<body style="display: block;">	
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">PerjalananKu</h1>
							<p class="text-white link-nav"><a href="akun.php">AkunKu </a>  <span class="lnr lnr-arrow-right"></span>  <a href="pesanan.php">PesananKu</a><span class="lnr lnr-arrow-right"></span>  <a href="Perjalanan.php">PerjalananKu</a></p>
						</div>	
					</div>
				</div>
			</section>
			<!-- End banner Area -->	
			    ...
			    <!-- ---------------------------------------- ISI ------------------------------------- -->
			<div class="wizard-v3-content" style="margin-left: 100px; width: 1120px;">
		        ...
		        <form class="form-register" action="#" method="post">
		        	<div id="form-total">
			            ...
			            <h2>
			            	...
			            	<span class="step-text">Penjemputan</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<h3>Detail Penjemputan :</h3>
			                	<div class="form-row">
			                	<p> Penjemputan di Terminal Mendolo pada jam 13:00.</p>
			            ...
			            <h2>
			            	...
			            	<span class="step-text">Sampai</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<h3>Detail:</h3>
			                	<div class="form-row">
			                	<p>Wisatawan sampai di Wonosobo pada pukul 14.00 WIB</p>
			            ...
			            <h2>
			            	...
			            	<span class="step-text">Penginapan</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<h3>Detail :</h3>
			                	<div class="form-row">
			                	<p>Wisatawan check-in di Hotel Kresna Wonosobo</p>

							</div>
			            </section>
			            <!-- SECTION 4 -->
			            <h2>
			            	<span class="step-icon"><i class="zmdi zmdi-cutlery"></i></span>
			            	<span class="step-text">Makan</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<h3>Detail:</h3>
			                	<div class="form-row">
			                	<p>Wisatawan sedang makan di restoran Sindoro Sumbing Wonosobo</p>

							</div>
			            </section>
			            <!-- selectin 5 -->
			             <h2>
			            	<span class="step-icon"><i class="zmdi zmdi-pin-drop"></i></span>
			            ...
			            <section>
			                <div class="inner">
			                	<h3>Detail :</h3>
			                	<div class="form-row">
			                	<p>Wisatawan sedang berada dalam perjalanan wisata di Wonosobo</p>

							</div>
			            </section>
			            <!-- selectin 6 -->
			            <h2>
			            	<span class="step-icon"><i class="zmdi zmdi-car-wash"></i></span>
			            	<span class="step-text">Pulang</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<h3>Detail :</h3>
			                	<div class="form-row">
			                	<p>Wisatawan telah selesai melakukan wisata. Trimakasih atas anda :)</p>
							</div>
			            </section>
		        	</div>
		        </form>
