...
<!-- isi -->
					...
					<p style="padding-left: 100px;">IDR 100.000/pax
						<br>Kecamatan Kejajar</p>	
					</br>
							            <div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="img/paket/p1.jpg" alt="">
								</div>
								<div class="desc">			
									<p>Telaga Warna</p>		
								</div>
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="img/paket/p2.jpg" alt="">
								</div>
								<div class="desc">			
									<p>Telaga Pengilon</p>		
								</div>
