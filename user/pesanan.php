				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">PesananKu</h1>
...
?>
		...
		<div>
          <h3 style="margin-top: 30px; margin-right: 100px; margin-left: 100px; margin-bottom: 15px; border-bottom: 1px solid #f8b600;">PesananKu</h3></p></legend>
            </div>
			<div>
                <table border="1" style="margin-left: 100px;">
                	...
                	<tr>
                		...
                		<th rowspan="2">Pilihan Paket</th>
                		<th rowspan="2">Tanggal Pesan</th>
                		<th rowspan="2">Tanggal Tour</th>
                	...
                	<tbody>
                		<tr>
                			<td>DW-00<?php echo $tampil['id_pesan'];?></td>
                			<td><?php echo $tampil['nama'];?></td>
                			<td><?php echo $tampil['nama_paket']; ?></td>
                			<td><?php echo $tampil['tgl_pesan'];?></td>
                			<td><?php echo $tampil['tgl_tour']; ?></td>
                            <td><?php echo $tampil['dewasa']; ?></td>
                            <td><?php echo $tampil['anak']; ?></td>
